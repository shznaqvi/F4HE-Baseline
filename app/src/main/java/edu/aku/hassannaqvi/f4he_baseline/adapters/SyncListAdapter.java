...
import edu.aku.hassannaqvi.f4he_baseline.databinding.SyncListAdapterBinding;
import edu.aku.hassannaqvi.f4he_baseline.models.SyncModel;

public class SyncListAdapter extends RecyclerView.Adapter<edu.aku.hassannaqvi.f4he_baseline.adapters.SyncListAdapter.SyncListViewHolder> {
