...
import edu.aku.hassannaqvi.f4he_baseline.workers.PhotoUploadWorker2;
                            ...
                            try {
                                ...
                                switch (tableName) {
                                    case UsersTable.TABLE_NAME:
                                        ...
                                        break;
                                    case TableContracts.VillagesTable.TABLE_NAME:
                                        jsonArray = new JSONArray(result);
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.f4he_baseline.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.f4he_baseline.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.f4he_baseline.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
