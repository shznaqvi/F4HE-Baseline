...
public class SectionCS4Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.Child_Table.COLUMN_SC4, child.sC4toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            //startActivity(new Intent(this, SectionCS5Activity.class).putExtra("complete", true));
