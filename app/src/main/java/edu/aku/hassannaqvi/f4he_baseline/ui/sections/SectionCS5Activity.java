...
public class SectionCS5Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.Child_Table.COLUMN_SC5, child.sC5toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            //startActivity(new Intent(this, SectionDS1Activity.class).putExtra("complete", true));
