...
public class FormB extends BaseObservable implements Observable {

    private final String TAG = "FormB";
    ...
    public FormB Hydrate(Cursor cursor) throws JSONException {
        ...
        this.sysDate = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SYSDATE));
        this.deviceId = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_DEVICEID));
        this.deviceTag = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_DEVICETAGID));
        this.appver = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_APPVERSION));
        this.iStatus = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_ISTATUS));
        this.synced = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SYNCED));
        this.syncDate = cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SYNCED_DATE));

        sB1Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB1)));
        sB2Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB2)));
        sB3Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB3)));
        sB41Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB41)));
        sB42Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB42)));
        sB5Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB5)));
        sB6Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB6)));
        sB7Hydrate(cursor.getString(cursor.getColumnIndexOrThrow(FormBTable.COLUMN_SB7)));
        return this;
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(FormBTable.COLUMN_SYSDATE, this.sysDate);
        json.put(FormBTable.COLUMN_DEVICEID, this.deviceId);
        json.put(FormBTable.COLUMN_DEVICETAGID, this.deviceTag);
        json.put(FormBTable.COLUMN_ISTATUS, this.iStatus);
        json.put(FormBTable.COLUMN_SB1, new JSONObject(sB1toString()));
        json.put(FormBTable.COLUMN_SB2, new JSONObject(sB2toString()));
        json.put(FormBTable.COLUMN_SB3, new JSONObject(sB3toString()));
        json.put(FormBTable.COLUMN_SB41, new JSONObject(sB41toString()));
        json.put(FormBTable.COLUMN_SB42, new JSONObject(sB42toString()));
        json.put(FormBTable.COLUMN_SB5, new JSONObject(sB5toString()));
        json.put(FormBTable.COLUMN_SB6, new JSONObject(sB6toString()));
        json.put(FormBTable.COLUMN_SB7, new JSONObject(sB7toString()));
        return json;
    }
