...
import edu.aku.hassannaqvi.f4he_baseline.databinding.ActivitySectionBs1AactivityBinding;
...
public class SectionBS1AActivity extends AppCompatActivity {
    ...
    ActivitySectionBs1AactivityBinding bi;
    private DatabaseHelper db;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this,R.layout.activity_section_bs1_aactivity);
        bi.setForm(form);
