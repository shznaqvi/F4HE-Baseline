...
public class SectionBS6Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SB6, form.sB6toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            //startActivity(new Intent(this, SectionBS7Activity.class).putExtra("complete", true));
