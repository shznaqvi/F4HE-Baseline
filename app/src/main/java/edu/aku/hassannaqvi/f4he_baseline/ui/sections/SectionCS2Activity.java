...
public class SectionCS2Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
       /* db = MainApp.appInfo.getDbHelper();
        long updcount = 0;
        try {
            updcount = db.updatesChildColumn(TableContracts.Child_Table.COLUMN_SC2, child.sC2toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            //startActivity(new Intent(this, SectionCS3AActivity.class).putExtra("complete", true));
