...
public class SectionDS1Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFormColumn(TableContracts.FormsTable.COLUMN_SD1, MainApp.form.sD1toString());
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            //startActivity(new Intent(this, SectionDS2Activity.class).putExtra("complete", true));
