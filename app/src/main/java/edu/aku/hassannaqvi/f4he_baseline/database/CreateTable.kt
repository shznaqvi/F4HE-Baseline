...
object CreateTable {
    ...
    const val SQL_CREATE_MOTHER_KAP = ("CREATE TABLE "
            ...
            + MotherKAPTable.COLUMN_FMUID + " TEXT,"
            + MotherKAPTable.COLUMN_MUID + " TEXT,"
...
/*    const val SQL_CREATE_FAMILY_MEMBERS = ("CREATE TABLE "
    ...
    const val SQL_CREATE_ADOLESCENT = ("CREATE TABLE "
            ...
            + LateAdolescentTable.COLUMN_FMUID + " TEXT,"
            + LateAdolescentTable.COLUMN_MUID + " TEXT,"
            + LateAdolescentTable.COLUMN_SNO_ADOL_FEM + " TEXT,"
            + LateAdolescentTable.COLUMN_SNO_ADOL_MALE + " TEXT,"
