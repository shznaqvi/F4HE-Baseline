...
public class MWRA extends BaseObservable implements Observable {
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(TableContracts.MwraTable.COLUMN_SD1, new JSONObject(sD1toString()));
        json.put(TableContracts.MwraTable.COLUMN_SD2, new JSONObject(sD2toString()));
        json.put(TableContracts.MwraTable.COLUMN_SD3, new JSONObject(sD3toString()));
        return json;
    }
