...
import edu.aku.hassannaqvi.f4he_baseline.databinding.ActivitySectionBs7Binding;
...
public class SectionBS7Activity extends AppCompatActivity {
    ...
    public void btnContinue(View view) {
        ...
        if (updateDB()) {
            finish();
            startActivity(new Intent(this, SectionCS1Activity.class).putExtra("complete", true));
